### fork notes:
This fork is an attempt to improve performance while removing some of the bits that I don't need for my electron apps. It's unlikely to be useful to anyone else. Sorry.
